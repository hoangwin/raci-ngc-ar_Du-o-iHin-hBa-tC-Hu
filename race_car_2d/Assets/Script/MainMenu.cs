...
public class MainMenu : MonoBehaviour {
	...
	void Start () {
        ...
        if(!GameObject.Find("SoundBgMusic").audio.isPlaying)
        ...
        {
            GameObject.Find("MMLabelSound").GetComponent<UILabel>().text = "Sound : On";
            AudioListener.pause = false;
        }
        else
        {
            GameObject.Find("MMLabelSound").GetComponent<UILabel>().text = "Sound : Off";
