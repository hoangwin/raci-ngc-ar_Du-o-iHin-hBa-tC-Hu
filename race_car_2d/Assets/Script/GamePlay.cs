...
public class GamePlay : MonoBehaviour {
    ...
    public void CalcScore()
    {
        ...
        GameObject.Find("LabelUIScore").GetComponent<UILabel>().text = "Time : "+score.ToString();
    ...
    public static void GameOver()
    {
       // Debug.Log("Game Over");
        ...
        state = STATE_OVER;
        GameObject.Find("OverLabelScore").GetComponent<UILabel>().text = "Time : " + score.ToString();
