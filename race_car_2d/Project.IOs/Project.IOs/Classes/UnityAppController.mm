...
- (void)startUnity:(UIApplication*)application
{
    ...
    GADBannerView *bannerView_ = [[GADBannerView alloc] initWithAdSize:kGADAdSizeBanner];//here
    // Specify the ad unit ID.
    bannerView_.adUnitID = @"a15357118de14b1";//admob  ban trung khung long  caogiaqn
