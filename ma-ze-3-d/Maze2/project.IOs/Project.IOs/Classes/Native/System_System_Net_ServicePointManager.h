...
struct ICertificatePolicy_t914;
...
struct  ServicePointManager_t913  : public Object_t
{
};
struct ServicePointManager_t913_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t872 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t900 * ___server_cert_cb_9;
};
