...
struct  X509Store_t943  : public Object_t
{
	...
	X509Certificate2Collection_t934 * ___list_2;
	...
	X509Store_t957 * ___store_4;
};
struct X509Store_t943_StaticFields{
	...
	Dictionary_2_t181 * ___U3CU3Ef__switchU24mapF_5;
};
