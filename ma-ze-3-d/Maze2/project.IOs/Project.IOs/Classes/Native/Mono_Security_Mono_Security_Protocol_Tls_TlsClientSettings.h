...
struct RSAManaged_t1065;

#include "mscorlib_System_Object.h"

// Mono.Security.Protocol.Tls.TlsClientSettings
struct  TlsClientSettings_t1166  : public Object_t
{
	...
	X509CertificateCollection_t906 * ___certificates_1;
