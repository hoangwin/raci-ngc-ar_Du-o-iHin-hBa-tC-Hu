...
struct CFX_AutoDestructShuriken_t2;

#include "mscorlib_System_Object.h"

// CFX_AutoDestructShuriken/<CheckIfAlive>c__Iterator0
struct  U3CCheckIfAliveU3Ec__Iterator0_t1  : public Object_t
{
	...
	// CFX_AutoDestructShuriken CFX_AutoDestructShuriken/<CheckIfAlive>c__Iterator0::<>f__this
	CFX_AutoDestructShuriken_t2 * ___U3CU3Ef__this_2;
};
