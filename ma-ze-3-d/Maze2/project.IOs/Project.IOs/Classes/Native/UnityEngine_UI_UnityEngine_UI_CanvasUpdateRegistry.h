...
struct Comparison_1_t358;

#include "mscorlib_System_Object.h"

// UnityEngine.UI.CanvasUpdateRegistry
struct  CanvasUpdateRegistry_t356  : public Object_t
{
	...
	IndexedSet_1_t357 * ___m_LayoutRebuildQueue_3;
