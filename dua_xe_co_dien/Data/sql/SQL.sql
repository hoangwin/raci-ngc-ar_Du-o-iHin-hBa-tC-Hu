...
CREATE TABLE IF NOT EXISTS `racing_2d` (
...
INSERT INTO `racing_2d` (`UserName`, `Time`, `Level`, `Played`, `Country`) VALUES
('Hello', 1, 1, 1, 0),
('aa', 1, 1, 1, 1),
('toanstt', 0, 0, 0, 0),
('nmtoan91', 0, 0, 0, 0),
...
//
INSERT INTO `b10_11763771_GameLeaderBoard`.`ArmyDefenderGame` (`UserName`, `Time`, `Level`, `Played`, `Country`) VALUES ('Hello', '1', '1', '1', 'VN');
